                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group comments">
                                        <input class="form-control" name="comment_name" id="comment_name" placeholder="Имя">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group comments">
                                        <textarea class="form-control" name="comment_comment" id="comment_comment" placeholder="Отзыв ..."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                                <div class="feedback">
                                    <div class="rating_cust">
                                        ...
                                        <div class="emoji-wrapper">
                                            <div class="emoji">
                                                <svg class="rating_cust-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                ...
                                                <svg class="rating_cust-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <circle cx="256" cy="256" r="256" fill="#ffd93b" />
                                                ...
                                                <svg class="rating_cust-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <circle cx="256" cy="256" r="256" fill="#ffd93b" />
                                                    <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534" />
                                                ...
                                                <svg class="rating_cust-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <circle cx="256" cy="256" r="256" fill="#ffd93b" />
                                                ...
                                                <svg class="rating_cust-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <circle cx="256" cy="256" r="256" fill="#ffd93b" />
                                                    <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534" />
                                                ...
                                                <svg class="rating_cust-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                    <g fill="#ffd93b">
